...
/* harmony import */ var _modules_effectc__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/effectc */ "./src/js/lib/modules/effectc.js");
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.on = function (eventName, callbaack) {
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.off = function (eventName, callbaack) {
  if (!eventName || !callbaack) {
    return this;
  }
...
<div class="dropdown">
    <button class="btn btn-primary dropdown-toggle" id="dropdownMenuuButton">Dropdown buttom</button>
    <div class="dropdown-menu" data-toggle-id="dropdownMenuuButton">
